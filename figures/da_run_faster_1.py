...
def draw_speed_only_fig():
    colors = [np.array(x) / 255 for x in [[70, 130, 180], [111, 111, 111]]]
    ...
    param_y_range_dict = {
        ...
        'peak_vgrf': (r'Generated Peak $f_v$ (\%Body Weight)', [230, 240, 250, 260, 270], [-1, 0], 0),
        'knee_angle_l_max': ('Generated Peak Knee Flexion (deg)', [100, 105, 110, 115, 120], [-2, 0], 1.5),
        'peak_apgrf': (r'Generated Peak $f_{ap}$ (\%Body Weight)', [20, 25, 30, 35, 40], [0, 0], -1.5),
    }
    ...
    plt.subplots_adjust(.08, .1, .98, .98)
