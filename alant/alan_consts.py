...
FORCE_ALL = [body + '_force_v' + axis for body in ['calcn_r', 'calcn_l'] for axis in ['x', 'y', 'z']]

MODEL_STATES_COLUMN_NAMES_NO_ARM = [
    'pelvis_tx', 'pelvis_ty', 'pelvis_tz', 'knee_angle_r', 'ankle_angle_r', 'knee_angle_l',
    'ankle_angle_l', 'lumbar_extension', 'lumbar_bending', 'lumbar_rotation', 'pelvis_0',
    'pelvis_1', 'pelvis_2', 'pelvis_3', 'pelvis_4', 'pelvis_5', 'hip_r_0', 'hip_r_1', 'hip_r_2', 'hip_r_3', 'hip_r_4',
    'hip_r_5', 'hip_l_0', 'hip_l_1', 'hip_l_2', 'hip_l_3', 'hip_l_4', 'hip_l_5']

MODEL_STATES_COLUMN_NAMES_WITH_ARM = [
    'pelvis_tx', 'pelvis_ty', 'pelvis_tz', 'knee_angle_r', 'ankle_angle_r', 'knee_angle_l',
    'ankle_angle_l', 'lumbar_extension', 'lumbar_bending', 'lumbar_rotation', 'elbow_flex_r',
    'pro_sup_r', 'elbow_flex_l', 'pro_sup_l', 'pelvis_0',
    'pelvis_1', 'pelvis_2', 'pelvis_3', 'pelvis_4', 'pelvis_5', 'hip_r_0', 'hip_r_1', 'hip_r_2', 'hip_r_3', 'hip_r_4',
...
DATASETS = ['Camargo2021', 'Carter2023', 'Fregly2012', 'Hammer2013', 'Han2023', 'Li2021', 'Moore2015',
